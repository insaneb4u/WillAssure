    ...
    public class AddwitnessController : Controller
    {
        ...
        public ActionResult AddwitnessIndex(string NestId, string send)
        {
            ...
            if (Session["distid"] != null && Session["willtype"] != null && Session["doctype"] != null)
            {
                ...
                //{
                //    queryc1 = "select * from BeneficiaryInstitutions where tId = " + Convert.ToInt32(Session["distid"]) + "      ";
                //}
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (count == 1)
                            {
                                ...
                                if (dt.Rows[i]["middleName"].ToString() != "None")
                                {
            ...
            if (dte.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dte.Rows.Count; i++)
                {
                    ...
                    if (dte.Rows[i]["middleName"].ToString() != "None")
                    {
